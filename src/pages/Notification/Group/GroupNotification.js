...
import {
  useGetGroupNotificationQuery,
  useDeleteGroupNotificationMutation,
} from "../../../redux/features/api/GroupNotificationApi";
...
const GroupNotification = () => {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useGetGroupNotificationQuery({ page: currentPage, search: searchTerm });
              ...
              <Col className="d-flex flex-row justify-content-between mt-1">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="d-none d-md-inline"> View Group</span>
                  </Button>
                </div>
              </Col>
            </Row>
