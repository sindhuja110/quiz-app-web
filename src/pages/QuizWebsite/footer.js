        ...
        <Container>
            <Row className='d-flex flex-row justify-content-center align-items-center'>
                ...
                <Col md={2} className="footer-section border-right">
                    <h4>Company</h4>
                    <ul>
                        <li><a href="https://driftmarktechnology.com/about" target='_blank' rel='noopener noreferrer'>about us</a></li>
                        <li><a href="https://driftmarktechnology.com/privacy-policy" target='_blank' rel='noopener noreferrer'>privacy policy</a></li>
                        <li><a href="https://driftmarktechnology.com/terms" target='_blank' rel='noopener noreferrer'>terms & conditions</a></li>
                    </ul>
                </Col>
                <Col md={2} className="footer-section border-right">
                    <h4>Quiz App</h4>
                ...
                <Col md={2} className="footer-section border-right">
                    ...
                    <ul>
                        ...
                        <li><a href="/features">Our Feature</a></li>
                    </ul>
                    <div className="social-icons">
                        <a href="https://api.whatsapp.com/send/?phone=916381475573&text&type=phone_number&app_absent=0" target='_blank' rel='noopener noreferrer'>
